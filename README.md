...
| Диагностика системы | Подробные результаты |
| --- | --- |
| ![Диагностика системы](docs/screenshots/diagnostics-window.png) | ![Подробные результаты](docs/screenshots/probe-details.png) |

### Редактирование целей

![Редактор targets.txt](docs/screenshots/targets-editor.png)
